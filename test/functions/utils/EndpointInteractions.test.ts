...
import * as EndpointInteractions from '../../../functions/utils/EndpointInteractions';
...
describe('Test EndpointInteractions', () => {
  ...
  test('Test successful followup', async () => {
    ...
    expect(mockedAxios.post).toBeCalledWith(expect.stringContaining(`https://discord.com/api/v10/webhooks/appid/token`), expect.anything(), expect.anything())
