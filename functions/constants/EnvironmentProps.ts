 ...
 */
export const discordClientSecretArn = process.env['DISCORD_CLIENT_SECRET_ARN'] ?? 'arn:aws:secretsmanager:us-east-1:247158676068:secret:DiscordClientSecret-NVaxza';